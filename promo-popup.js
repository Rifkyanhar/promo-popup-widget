 ...
 *
 * Widget ini menampilkan SATU pesan permanen berupa ajakan coba
 * langganan bulanan (TIDAK menyebut harga tetap/OTP sama sekali, supaya
 * customer journey nggak bingung lihat 2 harga beda dari 2 tempat).
 *
 * CARA PAKAI:
...
(function () {
  ...
  // ==== ISI PESAN — fokus ajakan coba langganan bulanan, TIDAK lagi ====
  // menyebut harga tetap (OTP) di sini sama sekali. Ini sengaja supaya
  // customer journey nggak kebingungan lihat 2 harga berbeda dari 2
  // tempat berbeda (LP utama vs popup ini) -- popup cuma jadi satu pintu
  // masuk: coba dulu lewat langganan, baru kenalan sama harga resmi kalau
  // memang lanjut ke paket sekali bayar (halaman /promo yang jelaskan itu).
  var VARIANT = {
    eyebrow: "🎁 Coba Dulu, Risiko Kecil",
    title: "Coba Semua Fitur, <span>Bayar Kalau Cocok</span>",
    desc: "Nggak perlu langsung komitmen besar. Coba Absensi Guru, Absensi Instansi, atau Sistem Menu Resto QR lewat langganan bulanan — fitur lengkap, bisa berhenti kapan saja kalau ternyata belum cocok. Kalau yakin, gampang upgrade ke paket sekali bayar (domain sendiri, masa berlaku 1 tahun).",
    linkUrl: "https://nafatech.web.id/promo/langganan.html",
    linkLabel: "Coba Langganan Sekarang",
  };
  // =======================================================================
